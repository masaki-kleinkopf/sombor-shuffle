  ...
  return (
    <div className="random-stat">
      ...
      <p className="opponent">
        ...
        <br></br>vs<br></br>
        {randomStat.opponent} {randomStat.opponent_score}
      </p>
      <div className="stats-container">
        <div className="bubble">
          {randomStat.points > 9 ? (
            <p className="stat stat-blue">{randomStat.points}</p>
          ) : (
            <p className="stat">{randomStat.points}</p>
          )}
        </div>
        <div className="bubble">
          {randomStat.rebounds > 9 ? (
            <p className="stat stat-blue">{randomStat.rebounds}</p>
          ) : (
            <p className="stat">{randomStat.rebounds}</p>
          )}
        </div>
        <div className="bubble">
          {randomStat.assists > 9 ? (
            <p className="stat stat-blue">{randomStat.assists}</p>
          ) : (
